...
contract ConfidentialSalary is SepoliaConfig {
    ...
    struct Employee {
        ...
        euint32 salary; // Encrypted salary amount
        bool isActive;
    ...
    function addEmployee(
        ...
        euint32 salary = FHE.fromExternal(encryptedSalary, salaryProof);
    ...
    function getEmployeeSalary(address employeeAddress) external view returns (euint32) {
    ...
    function getCompanyPayroll(address companyAddress) external view returns (euint32) {
    ...
    /// @param employeeAddress Employee's wallet address
    /// @return employeeAddress Employee's address
    ...
    function deactivateEmployee(address employeeAddress) external {
        ...
        euint32 salary = employees[employeeAddress].salary;
